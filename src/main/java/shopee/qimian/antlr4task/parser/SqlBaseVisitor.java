...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code singleTable}
	 * labeled alternative in {@link SqlBaseParser#aliasedRelation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSingleTable(SqlBaseParser.SingleTableContext ctx);
	/**
	 * Visit a parse tree produced by the {@code subTable}
	 * labeled alternative in {@link SqlBaseParser#aliasedRelation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSubTable(SqlBaseParser.SubTableContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code whereExpression}
	 * labeled alternative in {@link SqlBaseParser#booleanExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhereExpression(SqlBaseParser.WhereExpressionContext ctx);
	/**
