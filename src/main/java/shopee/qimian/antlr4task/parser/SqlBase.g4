...
aliasedRelation
    : relationPrimary                                                  #singleTable
    | relationPrimary (AS? identifier columnAliases?)?                 #subTable
    ;
...
booleanExpression
    ...
    | valueExpression predicate[$valueExpression.ctx]?             #whereExpression
